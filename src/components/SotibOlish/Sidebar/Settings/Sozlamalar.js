        ...
        <div className={'row list'} id={'setting'} onClick={toggle}>
            <div className="imgDiv" >
                <div className={'d-flex align-items-center'}>
                    ...
                    <h4 className={`sidebar-text ${fontsiza}`}>{t('Sidebar.40')}</h4>
                </div>
                ...
                <ul style={{width:'80%'}}>
                    <NavLink className={isActive => isActive ? 'active-enter-link li-text' : 'li-text'} to={'/headerthird/dukonSozlama'} ><li   className={'li-text'} onClick={sidebaractive}>{t('Sidebar.40')}</li></NavLink>
                    <NavLink className={isActive => isActive ? 'active-enter-link li-text' : 'li-text'} to={'/headerthird/bazalarSetting'}><li className={'li-text'} onClick={sidebaractive}>{t('Sidebar.41')}</li></NavLink>

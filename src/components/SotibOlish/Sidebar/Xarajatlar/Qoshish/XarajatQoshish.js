            ...
            <div className={'row  mt-4'}>
                ...
                <div className="col-12 border mt-4">
                    <div className="row">
                        <div className="col-4 col-sm-12">
                            ...
                            <label htmlFor={'mijoz'} className={'mt-4'}>{t('Trade.4')}</label>
                            ...
                            <label htmlFor={'mijoz'} className={'mt-4'}>{t('Purchase.11')}</label>
                        ...
                        <div className="col-4 col-sm-12">
                            <label htmlFor={'muddat'}>{t('Trade.24')}</label>
                            ...
                            {/*</div>*/}
                            <label htmlFor={'stat'} className={'mt-4'}>{t('Trade.25')}</label>
                            ...
                            <label htmlFor={'savRaqam'} className={'mt-4'}>{t('Expenses.10')}</label>
                        ...
                        {/*</Modal>*/}
                        <div className="col-4 col-sm-12">
                            <label htmlFor={'savOyna'}>{t('Buttons.17')}</label>
                            ...
                            <label htmlFor={'qoshim'} className={'mt-4'}>{t('Expenses.6')}</label>
                ...
                <div className={'col-md-10 offset-1 mt-5 border p-4'}>
                    <h5>{t('Purchase.32')}!: 0.00</h5>
                    {
                        ...
                        <button className={'btn btn-outline-primary me-2'} onClick={saqla}>{t('Buttons.2')}</button>
                        </Link> :
                        <button className={'btn btn-outline-primary me-2'} onClick={saqla}>{t('Buttons.2')}</button>
                    }   
                        <button className={'btn btn-outline-primary'}>{t('Trade.19')}</button>
                </div>
            </div>
        </div>
    )

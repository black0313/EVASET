            ...
            <div className="imgDiv" onClick={toggle}>
                <div className={'d-flex align-items-center'}>
                    ...
                    <svg className={`sidebar-img ${fill}`} width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <path d="M2 8.5H14.5" stroke="#3A3C40" stroke-width="1.5" stroke-miterlimit="10"
                              stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M6 16.5H8" stroke="#3A3C40" stroke-width="1.5" stroke-miterlimit="10"
                              stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M10.5 16.5H14.5" stroke="#3A3C40" stroke-width="1.5" stroke-miterlimit="10"
                              stroke-linecap="round" stroke-linejoin="round"/>
                        <path
                        ...
                        <path d="M20 9.5V3.5L22 5.5" stroke="#3A3C40" stroke-width="1.5" stroke-linecap="round"
                ...
                <svg className={`sidebar-img  ${classs}`} width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <path d="M8.91016 19.92L15.4302 13.4C16.2002 12.63 16.2002 11.37 15.4302 10.6L8.91016 4.07999"
                          stroke="#3A3C40" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                          stroke-linejoin="round"/>
                </svg>
            </div>
...
export default connect(({functionreducer: {func}}) => ({func}), {active})(Xarajatlar)
